                    ...
                    <nav className="navbar navbar-inverse navbar-fixed-top" role="navigation">
                                    ...
                                    <span className="pull-left">
                                        <img className="media-object" src="http://placehold.it/50x50" alt=""/>
                                                ...
                                                <div className="media-body">
                                                    ...
                                                    <p className="small text-muted"><i
                                                        className="fa fa-clock-o"></i> Yesterday at 4:32 PM</p>
                                ...
                                <ul className="dropdown-menu alert-dropdown">
                                    ...
                                    <li>
                                        <a href="#">Alert Name <span
                                            className="label label-danger">Alert Badge</span></a>
                                    </li>
                        ...
                        <div className="collapse navbar-collapse navbar-ex1-collapse">
                            <ul className="nav navbar-nav side-nav">
                                ...
                                <li>
                                    <a href="#"><i className="fa fa-fw fa-file"></i> Blank Page</a>
                                </li>
                                <li>
                                    <a href="#"><i className="fa fa-fw fa-dashboard"></i> RTL Dashboard</a>
                                </li>
                            </ul>
                        </div>
                    </nav>
