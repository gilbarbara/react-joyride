...
export default function ScrollDemo() {
  ...
  return (
    <div className="bg-gray-200 p-8 flex flex-col items-center justify-center flex-1 text-left">
      <Joyride
      ...
      <div className="app__scroller bg-white h-[50vh] max-w-4xl mx-auto p-4 overflow-scroll">
