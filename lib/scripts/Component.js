...
var Component = React.createClass({
    ...
    getProgress: function () {
        this._log(['joyride:getProgress', 'steps:', this.props.steps]);
    ...
    _renderLayer: function () {
        ...
        function render () {
            ReactDOM.render(component, joyrideElement, function () {
                this._calcPlacement.call(this);
    ...
    _unrenderLayer: function () {
        this._log(['joyride:unrenderLayer']);
        ReactDOM.unmountComponentAtNode(joyrideElement);
    },
