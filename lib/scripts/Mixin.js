...
var joyride = {
    ...
    onClickTooltip: function (e) {
        ...
        joyride.toggleTooltip(state.joyrideType === 'guided' && ['close', 'skip'].indexOf(type) === -1 && Boolean(joyride.steps[newIndex]), newIndex);
    },
    ...
    _joyrideRenderStep: function () {
        ...
        if (target) {
            if (state.joyrideShowTooltip) {
                ...
                if (state.joyrideShowSkipButton) {
                    buttons.skip = state.joyrideLocale.skip;
                }
                ...
                component = React.createElement(Tooltip, {
                    ...
                    showSkipButton: state.joyrideShowSkipButton,
                    step: currentStep,
