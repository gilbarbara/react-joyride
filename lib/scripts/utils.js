 ...
 */function getScrollContainer(scrollContainer){if(scrollContainer&&document.querySelector(scrollContainer)){return document.querySelector(scrollContainer);}return document.body;}