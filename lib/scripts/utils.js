'use strict';Object.defineProperty(exports,"__esModule",{value:true});exports.hexToRGB=hexToRGB;exports.getRootEl=getRootEl;exports.logger=logger;exports.sanitizeSelector=sanitizeSelector;exports.getScrollContainer=getScrollContainer;/*eslint-disable no-nested-ternary *//**
 * Convert hex to RGB
 *
 * @param {string} hex
 * @returns {Object}
...
if(selector.className){return'.'+selector.className.replace(' ','.');}}return selector;}function getScrollContainer(scrollContainer,defaultElement){if(scrollContainer&&document.querySelector(scrollContainer)){return document.querySelector(scrollContainer);}if(defaultElement){return defaultElement;}return document.body;}