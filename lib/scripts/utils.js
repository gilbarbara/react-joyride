 ...
 * @returns {Array}
 */function getBoundingClientRectFromElement(element){return{left:element.offsetLeft?element.offsetLeft:0,top:element.offsetTop?element.offsetTop:0,width:typeof element.width==='function'?element.width():element.offsetWidth,height:typeof element.height==='function'?element.height():element.offsetHeight};}