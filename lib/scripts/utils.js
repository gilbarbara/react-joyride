 ...
 * @returns {Element}
 */function getRootEl(){return['ie','firefox'].indexOf(getBrowser())>-1?document.documentElement:document.body;}function getScrollContainer(component,defaultElement){var props=component.props;if(props.scrollContainerSelector){return document.querySelector(props.scrollContainerSelector);}if(defaultElement){return defaultElement;}return document.body;}
