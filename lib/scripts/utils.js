'use strict';Object.defineProperty(exports,"__esModule",{value:true});exports.hexToRGB=hexToRGB;exports.getRootEl=getRootEl;exports.getScrollContainer=getScrollContainer;/*eslint-disable no-nested-ternary *//**
 * Convert hex to RGB
 *
 * @param {string} hex
 * @returns {Object}
 ...
 * @returns {Element}
 */function getRootEl(){return['ie','firefox'].indexOf(getBrowser())>-1?document.documentElement:document.body;}function getScrollContainer(scrollContainer,defaultElement){if(scrollContainer&&document.querySelector(scrollContainer)){return document.querySelector(scrollContainer);}if(defaultElement){return defaultElement;}return document.body;}