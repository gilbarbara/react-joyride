 ...
 * @returns {Element}
 */function getRootEl(){return['ie','firefox'].indexOf(getBrowser())>-1?document.documentElement:document.body;}function getScrollContainer(scrollContainer,defaultElement){if(scrollContainer){return document.querySelector(scrollContainer);}if(defaultElement){return defaultElement;}return document.body;}