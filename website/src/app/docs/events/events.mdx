...
<Callout type="tip">
  <p>This example uses controlled mode to show the full event surface. For most apps, uncontrolled mode plus `before` hooks covers conditional UI — see [Conditional / Dynamic Steps](/docs/recipes#conditional-dynamic-steps).</p>
</Callout>
