...
<Callout type="tip">
  <p>Default to uncontrolled. Use `stepIndex` only when an external system owns the index — see [Conditional / Dynamic Steps](/docs/recipes#conditional-dynamic-steps) for the common alternative.</p>
</Callout>
